    ...
    <Container>
      <FeatureBoxContainer>
        <TopFeatureBoxes>
          ...
          <div>
            <Wifi className="feature-icon" /> Free WiFi
          </div>
          <div>
            <LocalParking className="feature-icon" /> Free Parking
          </div>
          <div>
            <LocalFlorist className="feature-icon" /> Garden
          </div>
          <div>
            <Pool className="feature-icon" /> Swimming Pool
          </div>
          <div>
            <Flatware className="feature-icon" /> BBQ Facility
          </div>
        </TopFeatureBoxes>
        <BottomFeatureBoxes>
          <div>
          ...
          <div>
            <Shower className="feature-icon" /> Private Bathroom
          </div>
          <div>
            <LoyaltyOutlined className="feature-icon" /> Key Card Access
          </div>
          <div>
            <UpdateOutlined className="feature-icon" /> 24 Hours Service
          </div>
        </BottomFeatureBoxes>
      </FeatureBoxContainer>
      <SidebarDescContainer>
        <DescTextContainer>
          <h2>Stay in the heart of New Delhi</h2>
          <p>
            Offering luxury in Delhi's city centre, Radisson Connaught Place is
          ...
          <p>
            ...
            Hotel Connaught Place is 1.3 km from New Delhi Railway Station.
            Indira Gandhi International Airport is 14 km away
          </p>
          <p>
            This is our guests' favourite part of New Delhi, according to
            independent reviews.
          </p>
          <p>
        ...
        <Aside>
          ...
          <Details>
            ...
            <span>
              ...
              heart of New Delhi, hotel has an excellent location score of 8.6
            </span>
          </Details>
          <Details>
            ...
            <span>
              ...
              Vegetarian, Asian, American, Buffet. Free parking available at the
              hotel.
            </span>
          </Details>
          <Details>
